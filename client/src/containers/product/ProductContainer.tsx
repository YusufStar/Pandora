                ...
                <HorizontalList settings={settings}>
                  {
                    ...
                    productData.images.map(({ url }, index) => {
                      return <Magnifier imageUrl={url} key={index} />;
                    })
                  }
                </HorizontalList>
              </div>
            ...
            <div className="product-detail-page-detail-box relative col-span-2 sm:col-span-2 md:col-span-2 px-4 lg:col-span-1 xl:col-span-1">
              <div className="flex justify-between items-center">
                <div className="product-name-main w-11/12">
                  <h1 className="uppercase text-[#232323ff] text-base font-bold">
                    {productData.brand}
                  </h1>
                    ...
                    {productData.sizes.map((size: any, index: number) => {
                      return (
                        <div
                          ...
                          className={`py-1 px-4 mr-2 mb-2 transition-all duration-200 ease-in-out variant-types relative border-transparent border-2 cursor-pointer rounded-full ${
                            data.product.size_id === size.id
                              ? "selected-circle"
                              : ""
                          }`}
                        >
                ...
                <div className="flex">
                  <div className="flex mr-2 product-detail-quantity-boxes">
                    <div
                      ...
                      className="product-detail-quantity-box"
                    >
                      <svg
                        stroke="#000"
                        fill="#000"
          ...
          <div className="grid grid-cols-1 my-12 mt-8 px-4">
            <Tabs defaultValue={"detail"}>
              <TabsList className={"mx-auto w-fit"}>
                <TabsTrigger
                  className={"font-medium text-[15px] pb-1"}
                  value={"detail"}
                >
                  Urun Aciklamasi
                </TabsTrigger>
              ...
              <TabsContent
                value={"detail"}
                className={
                  "flex flex-col w-full max-w-3xl mx-auto mt-8 sm:mt-10 md:mt-10 lg:mt-10"
                }
              >
                <ul
                  className={
                    "[&_li]:text-[12px] lg:[&_li]:text-[14px] [&_li]:mb-2"
                  }
                >
                  <li>
                    -Halınız özel yöntemlerle üretilmiş polvis iplikler ile
                    akrilik çöken ipliklerden oluşmuştur. Yüksek sıklık ve kısa
                    hav boyundan dolayı “tozuma” yok denecek kadar azdır.
                  </li>
                  <li>
                    -Salonlarınızda ve evinizin her alanında kullanabileceğiniz
                    yüksek ilmek sayısına sahip halılardır.
                  </li>
                  <li>
                    -Halınızın tabanında pamuk atkı kullanılmıştır. Selülozik
                    elyafların doğal yapısından dolayı halınızın eninde bir
                    miktar daralma olabilir.
                  </li>
                  <li>
                    -Halı üzerine dökülen sıvı leke yapıcılarını zaman
                    kaybetmeden kuru bez veya kağıt havlu ile vakumlayarak alın.
                  </li>
                  <li>
                    -Halı üzerine dökülen katı leke yapıcılarını spatula ile
                    halıdan tamamen temizleyin.
                  </li>
                  <li>
                    -Halınızı kullanmadığınız durumlarda rulo yapıp yatay olarak
                    muhafaza edin, asla katlamayın, güneşten ve rutubetten
                    koruyun.
                  </li>
                  <li>
                    -Kimyasal ağartıcılar kullanmayın, profesyonel yardım
                    isteyin.
                  </li>
                </ul>
                ...
                <p className={"text-[12px] lg:text-[14px]"}>
                  ‘‘Majolika Halı Üretim Tesislerinde Üretilmiştir.’’
                </p>
              </TabsContent>
              <TabsContent
                value={"feature"}
                className={
                  "flex flex-col items-center w-full max-w-3xl mx-auto mt-8 sm:mt-10 md:mt-10 lg:mt-10"
                }
              >
                <ul
                  className={
                    "[&_li]:text-[12px] lg:[&_li]:text-[14px] [&_li]:mb-2 list-disc"
                  }
                >
