        ...
        <div className="container mx-auto mt-8 mb-4 pb-8">
            ...
            <div className="grid grid-cols-6 gap-10 px-4">
                <div className="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-4 xl:col-span-4 ">
                    {products.map(({product, size, quantity}, index) => {
                        return (
                            <div key={index} className={"w-full border-b py-4 relative h-fit"}>
                                <div className="absolute top-4 right-0 cursor-pointer hover:text-red-800">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                         color="#000" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <path
...
<div className="flex items-center">
    ...
    <div className="flex flex-col justify-between w-full">
        <div className="flex flex-col justify-between h-full pl-6 w-full">
            <div>
                ...
                <div className="[&_span]:text-[12px] sm:[&_span]:text-[13px]">
                    ...
                    <span className="variant-name">{formatCurrency(Number(cmToSquareMeter(size.dimensions).toFixed(2)) * product.price)}</span>
                </div>
        ...
        <div className="basket-quantity-main flex flex-row justify-between pl-6 items-center">
            <div className="flex items-center">
                <span className={"text-[#9da5af] text-[13px] sm:text-[14px]"}>Adet:</span>
                <span style={{color: "rgb(8, 8, 8)"}} className={"ml-1 text-[14px]"}>{quantity}</span>
            </div>
                        ...
                        <div className="flex flex-col basket-features items-center">
                            ...
                            <div className=" basket-feature gap-4"><span><svg stroke="currentColor" fill="none"
                                ...
                                points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5"
                                                                                            r="2.5"></circle><circle
                                cx="18.5" cy="18.5"
                                r="2.5"></circle></svg></span><span>14 gün içinde iade ve değişim</span></div>
                        </div>
                    </div>
                </div>
            </div>
