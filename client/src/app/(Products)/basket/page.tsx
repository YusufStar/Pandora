                                    ...
                                    <AlertDialog>
                                        <AlertDialogTrigger asChild>
                                            <svg stroke="currentColor" fill="currentColor"
                                                 className={'group-hover:stroke-red-500 group-hover:fill-red-500 transition-all duration-200'}
                                                 strokeWidth="0" viewBox="0 0 24 24"
                                                 color="#000" height="1em" width="1em"
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                <AlertDialogTitle>Bu ürünü silmek istediğinizden emin
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction
                                                    onClick={() => handleDeleteBasket(id as number)}>Continue</AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </div>
