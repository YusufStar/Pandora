...
const ProductDashboardPage = () => {
  ...
  return (
    <div className={"p-4 w-full h-full flex items-center justify-center"}>
      <div className="mx-auto max-w-screen-2xl max-h-[900px] overflow-y-auto w-full overflow-x-hidden border rounded relative">
        <Table>
          <TableCaption>
                  ...
                  <DialogContent className="sm:max-w-[500px]">
                    ...
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="col-span-3 flex flex-col px-3 py-2 rounded border flex flex-col gap-2">
